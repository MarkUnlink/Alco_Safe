...
List<Color> orangeGradients = [
  Color(0xffbd0000).withOpacity(0.0),
  Color(0xFFc11e00).withOpacity(0.0),
  Color(0xFFff0005).withOpacity(0.0),
];

List<Color> aquaGradients = [
  Color(0xFF791ce8).withOpacity(0.1),
  Color(0xFFad66ff).withOpacity(0.1),
];
...
class FooterWaveClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    var secondControlPoint = Offset(size.width - (size.width / 16), size.height);
